...
#%%
'''
Step1. load necessary things such as path, img names..
'''
ROOT = '/home/'
GALLERY_TEST_PATH = os.path.join(ROOT, 'gallery/bounding_box_test') # ROOT 폴더 -> csv 내 fn_name과 연결할 것(GALLERY_TEST_PATH와 csv 내 fn_name과 하나하나 join)
...
'''
전체 html 내용을 구성하는 main function
'''
def make_html(query_image, csv_name, html_name):
...
#%%
'''
Step2. execute the main function
'''
if __name__ == "__main__":
    for query_image in query_images:
        try:
            ...
            make_html(query_image, csv_name, html_name)
        except:
            pass